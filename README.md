...
Çağrı Yıldız : [c4gr1](https://github.com/c4gr1) <br>
Furkan Taşkın : [CODER656](https://github.com/CODER656) <br>
Mustafa Balaban : [Mbalaban1776](https://github.com/Mbalaban1776) <br>
Tuğrul Yapıcı : [Tugrulfg](https://github.com/Tugrulfg) <br>

## Screenshots

* Chatty Mobile <br><br>

    <img src = "chatty-images/chatty-mobile-create-account-page.jpg" height=400> &nbsp;
...
* Chatty Web <br><br>
    ...
    <img src = "chatty-images/chatty-web-create-account-page.jpg" height=400> &nbsp;
    <img src = "chatty-images/chatty-web-login-page.jpg" height=400> &nbsp;
    <img src = "chatty-images/chatty-web-main-page.jpg" height=400> &nbsp;
